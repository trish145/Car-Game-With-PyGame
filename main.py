...
bright_blue=(0,0,255)
display_width=800  #variabale
display_height=600
import time
import random

gamedisplays=pygame.display.set_mode((display_width,display_height))
pygame.display.set_caption("A Simple Car GAME By Me")
clock=pygame.time.Clock()
carimg=pygame.image.load('car1.png') #stored the image into this variable
backgroundpic=pygame.image.load("bg.jpg")
yellow_strip=pygame.image.load("ys.jpg")
...
def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        ...
        obs_pic=pygame.image.load("car8.jpg")
...
def message_display(text):
    ...
    gamedisplays.blit(textsurf,textrect)
    pygame.display.update()
    time.sleep(3) #whn car crashes how many time message should be displayed
    game_loop()
    
def crash():
    message_display("THOK DIYA NA")
...
def car(x,y):
    gamedisplays.blit(carimg,(x,y)) #blit enters this image into the window with x and y cordinates

def game_loop():    #all the works in the game is done by this loop/function only
    x=(display_width*0.45)
    y=(display_height*0.8)
    x_change=0    #xaxis
    obstacle_speed=9
